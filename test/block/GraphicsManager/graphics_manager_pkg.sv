package graphics_manager_pkg;
  ...
  `include "block/GameManager/classes/game_manager_env.sv"
  `include "block/GameManager/classes/game_manager_test.sv"
  `include "classes/graphics_manager_predictor.sv"
  `include "classes/graphics_manager_test.sv"
