class chain_bit_driver extends uvm_driver #(bit_transaction);

  `uvm_component_utils(chain_bit_driver)
  ...
  function new(string name = "chain_bit_driver", uvm_component parent = null);
